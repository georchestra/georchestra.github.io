  ...
  <col width="109">
    <col width="279">
      <col width="231">
        ...
        <tr>
          <td width="109" height="30" bgcolor="#e6e6e6" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">13h30</font>
              </font>
            </p>
          </td>
          <td width="279" bgcolor="#e6e6e6" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">Accueil</font>
              </font>
            </p>
          </td>
        ...
        <tr>
          <td width="109" height="94" bgcolor="#cfe7f5" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">14h30</font>
              </font>
            </p>
          </td>
          <td width="279" bgcolor="#cfe7f5" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">session 1</font>
              </font>
            </p> <p align="center">
              <br/>
            </p> <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 11pt">
                  <b>geOrchestra 16.12&nbsp;: version majeure</b>
                </font>
              </font>
            </p>
          </td>
          <td width="231" bgcolor="#cfe7f5" style="border: none; padding: 0cm">
            <p style="margin-left: 0.2cm; margin-right: 0.2cm">
              <font face="Helvetica LT Std, sans-serif">
                <font size="1" style="font-size: 8pt">Synth&egrave;se des changements et &eacute;volutions, pr&eacute;sentation des nouveaut&eacute;s (c&oelig;ur, modules compl&eacute;mentaires administrateur et utilisateur, outils).</font>
              </font>
        ...
        <tr>
          <td width="109" height="94" bgcolor="#ffff75" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">15h30</font>
              </font>
            </p>
          </td>
          <td width="279" bgcolor="#ffff75" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">session 2</font>
              </font>
            </p> <p align="center">
              <br/>
            </p> <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 11pt">
                  <b>La communaut&eacute; geOrchestra&nbsp;:<br/> c&rsquo;est quoi&nbsp;? C&rsquo;est qui&nbsp;?</b>
                </font>
              </font>
            </p>
          </td>
          <td width="231" bgcolor="#ffff75" style="border: none; padding: 0cm">
            <p style="margin-left: 0.2cm; margin-right: 0.2cm">
              <font face="Helvetica LT Std, sans-serif">
                <font size="1" style="font-size: 8pt">Pr&eacute;sentation du fonctionnement de la communaut&eacute; et des sites web ressources.</font>
              </font>
            </p> <p style="margin-left: 0.2cm; margin-right: 0.2cm">
              <br/>
            </p> <p style="margin-left: 0.2cm; margin-right: 0.2cm">
              <font color="#000000">
                <font face="Helvetica LT Std, sans-serif">
                  <font size="1" style="font-size: 8pt">
                    <i>Fabrice PHUNG, PSC geOrchestra</i>
                  </font>
                </font>
              </font>
            </p>
        ...
        <tr>
          <td width="109" height="112" bgcolor="#b6e689" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">16h00</font>
              </font>
            </p>
          </td>
          <td width="279" bgcolor="#b6e689" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 9pt">session 3</font>
              </font>
            </p> <p align="center">
              <br/>
            </p> <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 11pt">
                  <b>Quel avenir pour les IDG&nbsp;;</b>
                </font>
              </font>
            </p> <p align="center">
              <font face="Helvetica LT Std, sans-serif">
                <font size="2" style="font-size: 11pt">
                  <b>2007-2017&nbsp;: et maintenant ?</b>
                </font>
              </font>
            </p>
          </td>
          <td width="231" bgcolor="#b6e689" style="border: none; padding: 0cm">
            <p style="margin-left: 0.2cm; margin-right: 0.2cm">
              <font color="#000000">
                <font face="Helvetica LT Std, sans-serif">
                  <font size="1" style="font-size: 8pt">INSPIRE a significativement acc&eacute;l&eacute;r&eacute; la mise en place des IDG en France. La lib&eacute;ration des donn&eacute;es publiques prend le pas sur la diffusion norm&eacute;e des donn&eacute;es g&eacute;ographiques et la demande en donn&eacute;es cro&icirc;t. Que peuvent apporter les IDG&nbsp;?</font>
                </font>
              </font>
            </p> <p style="margin-left: 0.2cm; margin-right: 0.2cm">
              <br/>
              ...
              <font color="#000000">
                <font face="Helvetica LT Std, sans-serif">
                  <font size="1" style="font-size: 8pt">
                    <i>Fabrice PHUNG, G&eacute;oBretagne</i>
                  </font>
                </font>
              </font>
            </p>
        ...
        <tr>
          <td width="109" height="23" bgcolor="#e6e6e6" style="border: none; padding: 0cm">
            <p align="center">
              <font face="Helvetica LT Std, sans-serif">
