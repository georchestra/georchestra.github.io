...
<h3>Ordre des couches</h3>
<p>Le visualiseur prend en compte l’opacité signalée par les services WMS. Les
couches signalées <em>'opaque</em>' (c'est à dire <em>couvrantes</em>) sont
placées en dessous avec un effet de zoom progressif adapté aux fonds de plan.
Les données attributaires sont placées au dess
<div class="post-excerpt">
