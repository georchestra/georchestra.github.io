 ...
 * artefactos más livianos. Logramos reducir el peso entre 20% a 50% excluyendo la documentación, los ejemplos y las pruebas inutiles del archivo WAR. Con eso se reduce el ancho de banda (y el tiempo!) necesario para recuperar los artefactos de nuestra <a href="https://sdi.georchestra.org/ci/job/georchestra-template/" data-proofer-ignore>plataforma de integración continua autoalojado</a>.
